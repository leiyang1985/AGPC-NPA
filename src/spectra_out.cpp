...
int main()
{
	...
	J_pm_out(1);
	P_read();
	cout<<"space 0 has "<<N[0]<<" particle; space 1 has "<<N[1]<<" particle."<<endl;
	...
	basis_tot_out(M_tot);
	ham_tot_init();
	spe_to_ham_tot_evalue();
	PP_to_ham_tot_evalue();
	QQ_to_ham_tot_evalue();
	QQ_np_to_ham_tot_evalue();
